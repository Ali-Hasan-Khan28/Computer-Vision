...
datadir    = 'C:/Users/hp/OneDrive/Desktop/5thS/6th Semester Courses/Computer Vision/CV Assignment 1/Computer-Vision/Assigment01/data'      # the directory containing the images
resultsdir = 'C:/Users/hp/OneDrive/Desktop/5thS/6th Semester Courses/Computer Vision/CV Assignment 1/Computer-Vision/Assigment01/results'   # the directory for dumping results
...
for file in os.listdir(datadir):
    ...
    if file.endswith('.jpg'):
        ...
        #lines = cv2.HoughLinesP(np.uint8(255 * img_threshold), rhoRes, thetaRes, threshold=50, minLineLength=20, maxLineGap=5)
